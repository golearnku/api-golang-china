 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Thread filter($input = [], $filter = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Thread paginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Thread query()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Thread simplePaginateFilter($perPage = null, $columns = [], $pageName = 'page', $page = null)
...
class Thread extends Model implements Commentable
{
    ...
    protected $fillable = [
        ...
        'cache->likes_count',
        'cache->subscriptions_count',
        'cache->last_reply_user_id',
        'cache->last_reply_user_name',
        'popular_at',
    ];
    ...
    public function refreshCache()
    {
        ...
        $this->update([
            'cache' => \array_merge(self::CACHE_FIELDS, [
